...
void ssd1306_WriteString(char* str)
{
    while(*str)
    {
        ...
        switch(*str)
        {
            ...
            case 'C': ptr[0]=0x3E; ptr[1]=0x41; ptr[2]=0x41; break;
            case 'U': ptr[0]=0x3F; ptr[1]=0x40; ptr[2]=0x40; ptr[3]=0x3F; break;
            case '0': ptr[0]=0x3E; ptr[1]=0x45; ptr[2]=0x49; ptr[3]=0x3E; break;
            case '1': ptr[0]=0x00; ptr[1]=0x42; ptr[2]=0x7F; break;
            case '2': ptr[0]=0x62; ptr[1]=0x51; ptr[2]=0x49; ptr[3]=0x46; break;
            case '3': ptr[0]=0x22; ptr[1]=0x49; ptr[2]=0x49; ptr[3]=0x36; break;
            case '4': ptr[0]=0x18; ptr[1]=0x14; ptr[2]=0x12; ptr[3]=0x7F; break;
            case '5': ptr[0]=0x2F; ptr[1]=0x49; ptr[2]=0x49; ptr[3]=0x31; break;
            case '6': ptr[0]=0x3E; ptr[1]=0x49; ptr[2]=0x49; ptr[3]=0x32; break;
            case '7': ptr[0]=0x01; ptr[1]=0x71; ptr[2]=0x09; ptr[3]=0x07; break;
            case '8': ptr[0]=0x36; ptr[1]=0x49; ptr[2]=0x49; ptr[3]=0x36; break;
            case '9': ptr[0]=0x26; ptr[1]=0x49; ptr[2]=0x49; ptr[3]=0x3E; break;
            case ' ': break;
        }
